...
const Show = ({ getShow, match, shows, history }) => {
  ...
  let episodes, seasons, allEpisodes, specials, seasons_length;
  if (
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-12">
                <div className="Show-data">
                  ...
                  <p>
                    {" "}
                    Airs: Every {show.airsDayOfWeek} at {show.airsTime}{" "}
                  </p>
                  <p> Seasons: {episodes && seasons_length} </p>
                  <p> Total Episodes: {allEpisodes && allEpisodes.length} </p>
                </div>
              </div>
            </div>
          </div>
